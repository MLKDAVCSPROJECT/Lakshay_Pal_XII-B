...
# Images Intro
original = Image.open('E:/Lakshay Pal XII-B/Images/Patient_button.png')
resize = original.resize((193, 177), Image.ANTIALIAS)
patient_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/appointment_button.png')
resize = original.resize((193, 177), Image.ANTIALIAS)
appointment_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Doctors_button.png')
resize = original.resize((193, 177), Image.ANTIALIAS)
doctors_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Rooms_button.png')
resize = original.resize((193, 177), Image.ANTIALIAS)
rooms_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Medication_button.png')
resize = original.resize((193, 177), Image.ANTIALIAS)
medication_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Report_image.png')
resize = original.resize((193, 177), Image.ANTIALIAS)
report_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Back_button.png')
resize = original.resize((52, 41), Image.ANTIALIAS)
back_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_button.png')
resize = original.resize((106, 45), Image.ANTIALIAS)
add_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/remove_button.png')
resize = original.resize((176, 45), Image.ANTIALIAS)
remove_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_patient_records_button.png')
resize = original.resize((350, 110), Image.ANTIALIAS)
add_patient_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Check_patient_records_button.png')
resize = original.resize((350, 110), Image.ANTIALIAS)
check_patient_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Remove_patient_records_button.png')
resize = original.resize((350, 110), Image.ANTIALIAS)
remove_patient_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_patient_records_frame.png')
resize = original.resize((700, 450), Image.ANTIALIAS)
add_patient_frame_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Remove_patient_records_frame.png')
resize = original.resize((700, 450), Image.ANTIALIAS)
remove_patient_frame_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_appointment_button.png')
resize = original.resize((300, 110), Image.ANTIALIAS)
add_appointment_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Check_appointment_button.png')
resize = original.resize((300, 110), Image.ANTIALIAS)
check_appointment_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Remove_appointment_button.png')
resize = original.resize((300, 110), Image.ANTIALIAS)
remove_appointment_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_appointment_frame.png')
resize = original.resize((700, 450), Image.ANTIALIAS)
add_appointment_frame_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Remove_appointment_frame.png')
resize = original.resize((700, 450), Image.ANTIALIAS)
remove_appointment_frame_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_medication_button.png')
resize = original.resize((300, 110), Image.ANTIALIAS)
add_medication_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Check_medication_button.png')
resize = original.resize((300, 110), Image.ANTIALIAS)
check_medication_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Remove_medication_button.png')
resize = original.resize((300, 110), Image.ANTIALIAS)
remove_medication_button_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Add_medication_frame.png')
resize = original.resize((700, 450), Image.ANTIALIAS)
add_medication_frame_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Remove_medication_frame.png')
resize = original.resize((700, 450), Image.ANTIALIAS)
remove_medication_frame_img = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Open_rp_image.png')
resize = original.resize((185, 45), Image.ANTIALIAS)
open_rp = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/Create_rp_image.png')
resize = original.resize((203, 45), Image.ANTIALIAS)
create_rp = ImageTk.PhotoImage(resize)

original = Image.open('E:/Lakshay Pal XII-B/Images/save_image.png')
